...
import { IRoutingContext, IRouteEntry, IRouteComponent } from './types';
...
export default function RouterRenderer() {
  // Access the router
  const router = useContext<IRoutingContext>(RoutingContext);
  ...
  const [routeEntry, setRouteEntry] = useState<IRouteEntry>(router.get());
 ...
 */
function RouteComponent(props: IRouteComponent) {
  // todo type JSResource
